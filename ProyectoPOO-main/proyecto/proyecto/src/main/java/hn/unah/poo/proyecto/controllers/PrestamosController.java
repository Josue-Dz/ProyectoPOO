...
@Operation(summary = "Permite crear un nuevo préstamo para un cliente", description = """
 ...
 \nEl préstamo será asociado al cliente y se calculará la cuota mensual.""")
    ...
    @Operation(summary = "Asocia un préstamo a un cliente mediante su DNI",
    description = """
    Permite asociar un pr\u00e9stamo a un cliente identificado por su DNI. 
    Recibe un parametro de tipo `String` que contiene el DNI del cliente.
    \n El prestamo sera asociado al cliente
     y se actualizara su informacion en la base de datos.""")
